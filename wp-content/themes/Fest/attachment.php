...
<?php while ( have_posts() ) : the_post(); ?>
	<article class="attachment-page">
		...
		<section class="intro">
			<a class="btn" href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr(printf(__('Return to %s', GKTPLNAME), get_the_title($post->post_parent))); ?>" rel="gallery">
				<?php printf(__('<span></span> %s', GKTPLNAME ), get_the_title($post->post_parent)); ?>
			</a>
