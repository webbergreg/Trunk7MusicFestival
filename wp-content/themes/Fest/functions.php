...
require_once(gavern_file('gavern/widget.comments.php'));
require_once(gavern_file('gavern/widget.social.php'));
require_once(gavern_file('gavern/widget.speakers.php'));
